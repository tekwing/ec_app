                    ...
                    <div class="row">
                        <div class="col-xl-3">
                            ...
                            <!-- <div>
                                ...
                                <div class="pe-2 me-n1 mb-3" style="display:none;" data-simplebar style="height: 250px">
                                    <div id="upcoming-event-list" style="display:none;"></div>
                                </div>
                            <!-- </div> -->
                            <!--end card-->
                        </div> <!-- end col-->
                                        ...
                                        <div class="row event-form">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control d-none" placeholder="e.g. EC Meeting" type="text" name="title" id="event-title" required value="" />
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select d-none" name="category" id="event-category" required>
                                                        ...
                                                        <option value="bg-success-subtle">One time</option>
                                                        <option value="bg-primary-subtle">Recurrence </option>
                                                        <option value="bg-info-subtle">Meeting </option>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select d-none" name="category" id="event-recurrence" required>
                                                        <option value="bg-success-subtle">Daily</option>
                                                        <option value="bg-primary-subtle">Weekly </option>
                                                    </select>
                                                    <div class="invalid-feedback">Please select a valid event category</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select d-none" name="category" id="event-days" required>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control d-none" placeholder="" type="text" name="title" id="event-location" required value="" />
                                                    <div class="invalid-feedback">Please provide a valid event name</div>
                                                </div>
                                            </div>
                                            <!--end col-->
