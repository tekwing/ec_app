...
function eventClicked() {
    ...
    document.getElementById("event-categoryy").classList.replace("d-block", "d-none"), 
    document.getElementById("event-recurrence").classList.replace("d-block", "d-none"), 
...
function editEvent(e) {
    ...
    ("new-event" == t ? (document.getElementById("modal-title").innerHTML = "", 
        ...
        document.getElementById("btn-save-event").innerHTML = "Add Event", eventTyped) : "edit-event" == t ? (e.innerHTML = "Cancel", e.setAttribute("data-id", "cancel-event"), 
        document.getElementById("btn-save-event").innerHTML = "Update Event", e.removeAttribute("hidden"), eventTyped) : (e.innerHTML = "Edit", e.setAttribute("data-id", "edit-event"), eventClicked))()
}
...
function eventTyped() {
    ...
    document.getElementById("event-recurrence").classList.replace("d-none", "d-block"),
    document.getElementById("event-days").classList.replace("d-none", "d-block"),
...
document.addEventListener("DOMContentLoaded", function() {
    flatPickrInit();
     ...
     // Add event listener to the event category dropdown
     document.getElementById("event-category").addEventListener("change", function() {
        var selectedValue = this.value;

        // Check if the selected value is "bg-success-subtle"
        if (selectedValue === "bg-success-subtle") {
            // Hide the date and time input fields
            document.getElementById("event-start-date").parentNode.classList.add("d-none");
            document.getElementById("timepicker1").parentNode.classList.add("d-none");
            document.getElementById("timepicker2").parentNode.classList.add("d-none");
        } else {
            // Show the date and time input fields
            document.getElementById("event-start-date").parentNode.classList.remove("d-none");
            document.getElementById("timepicker1").parentNode.classList.remove("d-none");
            document.getElementById("timepicker2").parentNode.classList.remove("d-none");
        }
